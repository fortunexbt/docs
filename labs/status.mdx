...
Experiments can earn a release without pretending to be production systems. Seven revived projects now ship reproducible proofs; their external-world and operational claims remain deliberately bounded.
...
All seven projects have reached **Release** for a specific bounded surface. None inherits an **Operate** claim for an external system merely because its local proof is green.
